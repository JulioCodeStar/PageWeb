...
const productLinks = [
  { name: "Create APIs", href: "#", icon: <Code /> },
  { name: "Content Management", href: "#", icon: <LayoutDashboard /> },
];

const solutionLinks = [
  { name: "Ecommerce", href: "#", icon: <Shopping /> },
  { name: "Mobile applications", href: "#", icon: <Smartphone /> },
];
