...
export function BlogSection() {
  ...
  const fetchData = async() => {
    try {
      const res = await configAxios.get('blogs?fields[0]=date&fields[1]=title&fields[2]=author&fields[3]=excert&fields[4]=slug&populate=*');
    ...
    <section className="bg-gray-50 overflow-hidden">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-24">
        ...
        <div className="mx-auto max-w-3xl text-center space-y-4 mb-8 sm:mb-12 lg:mb-16">
          ...
          <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-semibold leading-tight tracking-tight text-gray-900 mb-6">
            Artículos recientes sobre prótesis y{" "}
            <span className="block mt-1 sm:mt-2">sus usuarios</span>
          </h2>
        </div>
                ...
                <article className="group flex flex-col bg-white rounded-xl shadow-sm transition-all duration-300 hover:shadow-lg overflow-hidden h-full">
                  ...
                  <div className="relative aspect-[16/10] w-full overflow-hidden">
                    <Image
                      ...
                      src={blog.feature_img[0].url || "https://picsum.photos/1000"}
                      alt={blog.title}
                      fill
